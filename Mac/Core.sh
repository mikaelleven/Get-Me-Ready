...
curl -s http://getmacapps.com/raw/13ydj5 | sh # f.lux
...
curl -s http://getmacapps.com/raw/18y69 | sh # iterm2
#brew cask install caffeine
curl -s http://getmacapps.com/raw/5m9t | sh # Caffeine
...
curl -s http://getmacapps.com/raw/3 | sh # Chrome
#brew cask install --appdir="/Applications" firefox
curl -s http://getmacapps.com/raw/9 | sh # FireFox
...
curl -s http://getmacapps.com/raw/9zldt | sh # FileZilla
#brew cask install --appdir="/Applications" spotify
curl -s http://getmacapps.com/raw/1t | sh # Spotify
#brew cask install --appdir="~/Applications" vlc
curl -s http://getmacapps.com/raw/3l | sh # VLC Player
...
curl -s http://getmacapps.com/raw/b8jl | sh
