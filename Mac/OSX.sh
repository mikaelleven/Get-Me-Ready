...
sudo scutil --set ComputerName "macbook09"
sudo scutil --set HostName "macbook09"
sudo scutil --set LocalHostName "macbook09"
sudo defaults write /Library/Preferences/SystemConfiguration/com.apple.smb.server NetBIOSName -string "macbook09"
...
echo "Done. Note that some of these changes require a logout/restart to take effe